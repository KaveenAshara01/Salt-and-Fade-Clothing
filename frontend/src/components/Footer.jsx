        ...
        <div className="footer-grid hide-mobile">
          ...
          <div className="footer-section footer-brand">
            <Link to="/">
              <img
                ...
                alt="Salt & Fade"
                style={{ height: '35px', width: 'auto', marginBottom: '1.5rem', filter: 'brightness(0) invert(1)' }}
              />
            </Link>
          ...
          <div style={{ textAlign: 'right', display: 'flex', flexDirection: 'column', alignItems: 'flex-end' }}>
            ...
            <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'center', justifyContent: 'flex-end', marginBottom: '1.5rem' }}>
              <a href="https://www.instagram.com/salt_and_fade?igsh=MWZueDJ0ZDJ2cjUyZA==" target="_blank" rel="noreferrer" className="footer-link"><Instagram size={22} /></a>
              <a href="https://www.facebook.com/share/1GSfTBfHgc/" target="_blank" rel="noreferrer" className="footer-link"><Facebook size={22} /></a>
              <a href="https://wa.me/94771070544" target="_blank" rel="noreferrer" className="footer-link">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', alignItems: 'flex-end' }}>
              ...
              <a href="tel:+94771070544" className="footer-link" style={{ fontSize: '0.85rem' }}>+94 77 107 0544</a>
            </div>
          </div>
        </div>
            ...
            <div className="footer-col-right">
              <div className="footer-section">
                ...
                <div className="footer-social-icons" style={{ display: 'flex', gap: '1.25rem', alignItems: 'center', marginBottom: '1.25rem' }}>
                  <a href="https://www.instagram.com/salt_and_fade?igsh=MWZueDJ0ZDJ2cjUyZA==" target="_blank" rel="noreferrer" className="footer-link"><Instagram size={20} /></a>
                  <a href="https://www.facebook.com/share/1GSfTBfHgc/" target="_blank" rel="noreferrer" className="footer-link"><Facebook size={20} /></a>
                  <a href="https://wa.me/94771070544" target="_blank" rel="noreferrer" className="footer-link">
